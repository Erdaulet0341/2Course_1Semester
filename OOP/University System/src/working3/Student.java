...
class Student extends User implements CanDoResearch, CanDoDiploma ,Serializable{
	...
	public Vector<Book> PersonalLibrary = new Vector<Book>();
	...
	public void getBook(String name,DataBase db) {
		for(Book bk : db.eBooks) {
			if(bk.getName().equals(name)) {
				this.PersonalLibrary.add(bk);
			}
		}
	}
